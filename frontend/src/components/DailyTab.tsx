    ...
    <div>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <img src="/flute-logo.svg" alt="Flute" style={{ width: '38px', height: '38px', objectFit: 'contain', animation: 'float 4s ease-in-out infinite', filter: 'drop-shadow(0 0 8px var(--gold-glow))' }} />
          <div>
